...
% Titel (optional, kann auskommentiert werden, wenn nicht benötigt)
\node[font=\Large\bfseries, anchor=south west, above=0.7cm of banken.north west]
    {1.1 \hspace*{0.5em} Aufbau eines Rechners};
